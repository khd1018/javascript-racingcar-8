...
const ERROR_MESSAGE = {
  ...
  TOO_FEW_NAMES: `${ERROR_PREFIX} 이름을 2개 이상 입력해주세요. `,
  TOO_MANY_NAMES: `${ERROR_PREFIX} 이름을 100개 이하로 입력해주세요. `,
  INVALID_DELIMITER: `${ERROR_PREFIX} 이름을 쉼표(,)로 구분해서 입력해주세요. `,
  INVALID_NAME_LENGTH: `${ERROR_PREFIX} 자동차 이름은 5자 이하만 가능합니다.`,
  INVALID_FINAL_ROUND: `${ERROR_PREFIX} 시도할 횟수는 1이상 100이하 숫자만 입력해주세요.`,
};
